...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 for yy=1
     yy
 [yt_unperb, wy_unperb] = ode45(@HOI_ROS_nSPecies,[tt tt+450000],ystart1,op);
...
%    plot(time, X(:,6),'linewidth',3);
   legend('$x_1$','$x_2$','$x_3$','$x_4$','Interpreter','LaTeX','FontSize',24)
...
%%%%%%%%%%%%%%%%
%%
time1=yt_unperb(1:92000);
 X1=wy_unperb(1:92000,:);
%  X = [1 2 3; 1 2 3; 1 2 3];
% Y = X';
...
%%
% figure;
% plot(zz,yend(1:3),'-*','markersize',36,'linewidth',4)
% hold on
% set(findall(gcf,'-property','FontSize'),'FontName','Helvetica','FontSize',35,'linewidth',3.0,'fontweight','b')   
% %  ylim([-0.0 0.6]);
% %  xlim([0.75 11.75]);
